...
# Define the target path for the training script
train_model_path = Path(__file__).parent.parent.parent / "models" / "train_model.py"

# Write the training script
train_model_code = '''import json
import pandas as pd
import joblib
